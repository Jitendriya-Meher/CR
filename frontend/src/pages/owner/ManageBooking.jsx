...
const ManageBooking = () => {
  ...
  const changeBookings = async (bookingId, status) => {
  ...
  return (
    <div className=' px-4 pt-10 md:px-10 w-full'>
      ...
      <Title2
        ...
        subTitle={"View all listed bookings"}
      />
              ...
              bookings.map((booking,index) => (
                <tr key={index} className=' border-t border-borderColor text-gray-500'>
                  ...
                  <td className=' p-3 flex items-center gap-3'>
                    ...
                    <img src={booking.car.image} className=' h-12 w-12 aspect-square rounded-md object-cover object-center' alt="" />
                  ...
                  <td className=' p-3 '>
                    
                   {
                    booking.status === "pending" ? (
                      ...
                      onChange={(e) => {
                        changeBookings(booking._id, e.target.value)
                      }}
                      >
